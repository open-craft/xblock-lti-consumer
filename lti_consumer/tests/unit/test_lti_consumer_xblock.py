...
from lti_consumer.lti_consumer_xblock import LtiConsumerXBlock, parse_handler_suffix
...
class TestProperties(TestLtiConsumerXBlock):
    ...
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.course')
    ...
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.context_id')
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.resource_link_id')
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.user_id', PropertyMock(return_value=FAKE_USER_ID))
    ...
    def test_is_past_due_timezone_now_called(self):
        ...
        self.xblock.graceperiod = None
        self.xblock.due = now
        with patch('lti_consumer.lti_consumer_xblock.timezone.now', wraps=timezone.now) as mock_timezone_now:
...
class TestLtiLaunchHandler(TestLtiConsumerXBlock):
    ...
    @patch('lti_consumer.lti_consumer.LtiConsumer.get_signed_lti_parameters')
...
class TestResultServiceHandler(TestLtiConsumerXBlock):
    ...
    @patch('lti_consumer.lti_consumer_xblock.log_authorization_header')
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.lti_provider_key_secret')
    ...
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.is_past_due')
    ...
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumer.get_result')
    @patch('lti_consumer.lti_consumer.LtiConsumer.verify_result_headers', Mock(return_value=True))
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.is_past_due')
    ...
    @patch('lti_consumer.lti_consumer.LtiConsumer.verify_result_headers')
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
    ...
    @patch('lti_consumer.lti_consumer_xblock.LtiConsumer.verify_result_headers', Mock(return_value=True))
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
    ...
    @patch('lti_consumer.lti_consumer.LtiConsumer.get_result')
    @patch('lti_consumer.lti_consumer.LtiConsumer.verify_result_headers', Mock(return_value=True))
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
    ...
    @patch('lti_consumer.lti_consumer.LtiConsumer.put_result')
    @patch('lti_consumer.lti_consumer.LtiConsumer.verify_result_headers', Mock(return_value=True))
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
    ...
    @patch('lti_consumer.lti_consumer.LtiConsumer.delete_result')
    @patch('lti_consumer.lti_consumer.LtiConsumer.verify_result_headers', Mock(return_value=True))
    @patch('lti_consumer.lti_consumer_xblock.parse_handler_suffix')
...
class TestProcessorSettings(TestLtiConsumerXBlock):
    ...
    def test_enable_processor(self):
        ...
        with patch('lti_consumer.lti_consumer_xblock.LtiConsumerXBlock.get_settings', return_value=self.settings):
            processors = list(self.xblock.get_parameter_processors())
